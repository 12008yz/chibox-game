...
const ADDITIONAL_ITEMS_CONFIG = [
  {
    caseId: '88888888-8888-8888-8888-888888888888', // Бронзовый кейс - 17₽
    caseName: 'Бронзовый кейс (17₽)',
    priceRanges: [
      { min: 2000, max: 3999, count: 2 }, // Добавляем 2 джекпота за 2000-3999₽
    ],
  },
  {
    caseId: '99999999-9999-9999-9999-999999999999', // Пушистый кейс - 49₽
    caseName: 'Пушистый кейс (49₽)',
    priceRanges: [
      { min: 2000, max: 3999, count: 2 }, // Добавляем 2 джекпота за 2000-3999₽
    ],
  },
  {
    caseId: '66666666-6666-6666-6666-666666666666', // Стандартный кейс - 99₽
    caseName: 'Стандартный кейс (99₽)',
    priceRanges: [
      { min: 2000, max: 3999, count: 3 }, // Добавляем 3 джекпота за 2000-3999₽
    ],
  },
  {
