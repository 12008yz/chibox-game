...
const CASE_CONFIGS = [
  ...
  },
  {
    ...
    name: 'Золотой кейс',
    price: 100,
    // 60% дешевых, 30% средних, 10% дорогих
    priceRanges: [
      { min: 10, max: 100, count: 40 },
      { min: 100, max: 500, count: 25 },
      { min: 500, max: 1500, count: 15 }
    ]
  },
  {
  ...
  },
  {
    ...
    name: 'Алмазный кейс',
    price: 500,
    // 40% дешевых, 40% средних, 20% дорогих
    priceRanges: [
      { min: 30, max: 300, count: 30 },
      { min: 300, max: 1500, count: 30 },
      { min: 1500, max: 5000, count: 20 }
    ]
  },
  {
  ...
  },
  {
    ...
    price: 2500,
    // 20% дешевых, 50% средних, 30% дорогих
    priceRanges: [
      { min: 100, max: 800, count: 15 },
      { min: 800, max: 3000, count: 35 },
      { min: 3000, max: 15000, count: 25 }
    ]
  },
  {
