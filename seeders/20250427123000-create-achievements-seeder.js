  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('achievements', [
      ...
      },
      {
        ...
        xp_reward: 700,
        icon_url: '/Achievements/Платиновый торговец-no-bg-previe.png',
      ...
      },
      {
        ...
        xp_reward: 900,
        icon_url: '/Achievements/Успешный улучшатель-no-bg-previe.png',
      ...
      },
      {
        ...
        xp_reward: 500,
        icon_url: '/Achievements/Удача новичка.png',
