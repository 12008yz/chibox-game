    ...
    await queryInterface.bulkInsert('achievements', [
      {
        ...
        xp_reward: 100,
        icon_url: '/Achievements/BEGINNER 10cases-no-bg-preview.png',
      ...
      },
      {
        ...
        xp_reward: 200,
        icon_url: '/Achievements/Коллекционер-no-bg-preview.png',
      ...
      },
      {
        ...
        xp_reward: 400,
        icon_url: '/Achievements/Подписчик-no-bg-preview.png',
      ...
      },
      {
        ...
        xp_reward: 150,
        icon_url: '/Achievements/Покупатель подписки-no-bg-preview.png',
      ...
      },
      {
        ...
        xp_reward: 500,
        icon_url: '/Achievements/Миллионер-no-bg-preview.png',
      ...
      },
      {
        ...
        xp_reward: 600,
        icon_url: '/Achievements/Эксперт-no-bg-preview.png',
      ...
      },
      {
        ...
        xp_reward: 800,
        icon_url: '/Achievements/легенда-no-bg-preview.png',
      ...
      },
      {
        ...
        xp_reward: 700,
        icon_url: '/Achievements/Платиновый торговец-no-bg-preview.png',
      ...
      },
      {
        ...
        xp_reward: 1000,
        icon_url: '/Achievements/Мастер открытий-no-bg-preview.png',
        requirement_type: 'cases_opened',
      ...
      },
      {
        ...
        xp_reward: 900,
        icon_url: '/Achievements/Успешный улучшатель-no-bg-preview.png',
      ...
      },
      {
        ...
        xp_reward: 800,
        icon_url: '/Achievements/Элитный игрок-no-bg-preview.png',
      ...
      },
      {
        ...
        xp_reward: 2000,
        icon_url: '/Achievements/Открыватель-профи-no-bg-preview.png',
        requirement_type: 'cases_opened',
      ...
      },
      {
        ...
        xp_reward: 1500,
        icon_url: '/Achievements/Удачливая серия-no-bg-preview.png',
      ...
      },
      {
        ...
        xp_reward: 2500,
        icon_url: '/Achievements/Элита элит-no-bg-preview.png',
        requirement_type: 'level_reached',
      ...
      },
      {
        ...
        xp_reward: 1200,
        icon_url: '/Achievements/Джекпот-no-bg-preview.png',
