...
function calculateCorrectWeightByPrice(price) {
  ...
  if (price >= 3000) return 4;         // ~0.2% - редкие+ (1 из 500)
  if (price >= 2000) return 8;         // ~0.5% - необычные++ (1 из 200)
  if (price >= 1500) return 15;        // ~1% - необычные+ (1 из 100)
  if (price >= 1000) return 30;        // ~2% - необычные (1 из 50)
  if (price >= 500) return 60;         // ~5% - обычные+ (1 из 20)
  if (price >= 300) return 100;        // ~8% - обычные (1 из 12)
  if (price >= 100) return 150;        // ~12% - частые (1 из 8)
