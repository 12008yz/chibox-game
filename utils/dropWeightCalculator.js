 ...
 */
 function calculateBonusMultiplier(category, bonusPercentage) {
    ...
    const baseBonusMultipliers = {
        'legendary': 1.08,      // +8% к весу легендарных при 1% бонуса (было 15%)
        'mythical': 1.06,       // +6% к весу мифических при 1% бонуса (было 12%)
        'epic': 1.05,           // +5% к весу эпических при 1% бонуса (было 10%)
        'very_rare': 1.04,      // +4% к весу очень редких при 1% бонуса (было 8%)
        'rare': 1.03,           // +3% к весу редких при 1% бонуса (было 6%)
        'uncommon_plus': 1.02,  // +2% к весу необычных+ при 1% бонуса (было 4%)
        'uncommon': 1.01,       // +1% к весу необычных при 1% бонуса (было 2%)
        'common_plus': 1.005,   // +0.5% к весу обычных+ при 1% бонуса (было 1%)
        'common': 1.0,          // Без изменений для обычных
        'frequent': 0.99,       // -1% к весу частых при 1% бонуса (было -2%)
        'very_frequent': 0.97,  // -3% к весу очень частых при 1% бонуса (было -5%)
        'cheap': 0.95           // -5% к весу дешевых при 1% бонуса (было -10%)
    };
